...
public class TerminverwaltungGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMI_RaeumeLaden.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMI_RaeumeLadenActionPerformed(evt);
            }
        });
        ...
        jMI_RaumHinzufuegen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMI_RaumHinzufuegenActionPerformed(evt);
            }
        });
    ...
    private void jMI_RaeumeLadenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMI_RaeumeLadenActionPerformed

      TerminverwaltungTest test= new TerminverwaltungTest();
      test.testeXMLReaderRaumliste();
    }//GEN-LAST:event_jMI_RaeumeLadenActionPerformed

    private void jMI_RaumHinzufuegenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMI_RaumHinzufuegenActionPerformed
      //DIALOG IM SPRINT 2
TerminverwaltungTest test=new TerminverwaltungTest();
test.testeRaumhinzufuegen();
    }//GEN-LAST:event_jMI_RaumHinzufuegenActionPerformed
